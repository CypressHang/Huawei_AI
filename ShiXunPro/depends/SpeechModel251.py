...
from depends.general_function.file_wav import *
from depends.general_function.file_dict import *
from depends.general_function.gen_func import *
...
from depends.readdata24 import DataSpeech
...
class ModelSpeech(): # 语音模型类
	...
	def CreateModel(self):
		...
		# print('[*Info] Create Model Successful, Compiles Model Successful. ')#不提示了
